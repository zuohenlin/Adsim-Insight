...
MYSQL_DB_PWD = "echolens"
MYSQL_DB_USER = "echolens"
MYSQL_DB_HOST = "127.0.0.1"
MYSQL_DB_PORT = 5444
MYSQL_DB_NAME = "echolens"
...
POSTGRESQL_DB_PWD = os.getenv("POSTGRESQL_DB_PWD", "echolens")
POSTGRESQL_DB_USER = os.getenv("POSTGRESQL_DB_USER", "echolens")
POSTGRESQL_DB_HOST = os.getenv("POSTGRESQL_DB_HOST", "127.0.0.1")
POSTGRESQL_DB_PORT = os.getenv("POSTGRESQL_DB_PORT", "5444")
POSTGRESQL_DB_NAME = os.getenv("POSTGRESQL_DB_NAME", "echolens")
